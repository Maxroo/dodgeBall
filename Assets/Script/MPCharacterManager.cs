...
public class MPCharacterManager : MonoBehaviour
{
    ...
    public int p2colorIndex,p3colorIndex,p4colorIndex;
    public int p1characterIndex;
    public int p2characterIndex,p3characterIndex,p4characterIndex;
    ...
    public int p1Index;
    public int p2Index,p3index,p4index;
    public playerSelection p1;
    public playerSelection p2;
    public playerSelection p3;
    public playerSelection p4;
    public static MPCharacterManager instance;
    ...
    public void gameScene()
    {
        ...
        p3characterIndex = p3.index;
        p4characterIndex = p4.index;
        p3colorIndex = p3.colorIndex;
        p4colorIndex = p4.colorIndex;
